...
class AEstrella:
    ...
    def h_score(nodoActual, end):



        distance =  abs(nodoActual.x - end.x) + abs(nodoActual.y - end.y)
        ...
        for vecino in vecinos:
            ...
            if (vecino in closedSet) or (vecino.obstaculo == True):
                ...
                for k in range(len(openSet)):
                    ...
                    if vecino.x == openSet[k].x and vecino.y == openSet[k].y:
                        ...
                        if temp_g < openSet[k].g:
                            ...
                            openSet[k].h= AEstrella.h_score(openSet[k], end)
                ...
                if control_flag == 1:
                    ...
                    vecino.h = AEstrella.h_score(vecino, end)
